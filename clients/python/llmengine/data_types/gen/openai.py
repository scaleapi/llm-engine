...
#   timestamp: 2026-01-09T23:46:14+00:00
...
class Owner(BaseModel):
    type: Annotated[
        str | None, Field(description='Always `user`', example='user')
    ] = None
    object: Annotated[
        str | None,
        Field(
    ...
    role: Annotated[
        str | None, Field(description='Always `owner`', example='owner')
    ] = None
...
class ChatCompletionRequestUserMessageContentPart(BaseModel):
    __root__: ChatCompletionRequestMessageContentPartText | ChatCompletionRequestMessageContentPartImage | ChatCompletionRequestMessageContentPartAudio | ChatCompletionRequestMessageContentPartFile
...
class AnnotationModel(BaseModel):
    __root__: Annotated[
        FileCitationBody | UrlCitationBody | FilePath, Field(discriminator='type')
    ]
...
class ChatCompletionRequestAssistantMessageContentPart(BaseModel):
    __root__: ChatCompletionRequestMessageContentPartText | ChatCompletionRequestMessageContentPartRefusal
...
class MessageStreamEvent(BaseModel):
    __root__: MessageStreamEvent1 | MessageStreamEvent2 | MessageStreamEvent3 | MessageStreamEvent4 | MessageStreamEvent5
...
class ChatCompletionRequestMessage(BaseModel):
    __root__: ChatCompletionRequestDeveloperMessage | ChatCompletionRequestSystemMessage | ChatCompletionRequestUserMessage | ChatCompletionRequestAssistantMessage | ChatCompletionRequestToolMessage | ChatCompletionRequestFunctionMessage
...
class RunStepStreamEvent(BaseModel):
    __root__: RunStepStreamEvent1 | RunStepStreamEvent2 | RunStepStreamEvent3 | RunStepStreamEvent4 | RunStepStreamEvent5 | RunStepStreamEvent6 | RunStepStreamEvent7
...
class RunStreamEvent(BaseModel):
    __root__: RunStreamEvent1 | RunStreamEvent2 | RunStreamEvent3 | RunStreamEvent4 | RunStreamEvent5 | RunStreamEvent6 | RunStreamEvent7 | RunStreamEvent8 | RunStreamEvent9 | RunStreamEvent10
