...
#   timestamp: 2026-01-09T22:40:40+00:00
...
if PYDANTIC_V2:
    from pydantic.v1 import AnyUrl, BaseModel, Extra, Field, constr  # noqa: F401
else:
    from pydantic import AnyUrl, BaseModel, Extra, Field, constr  # type: ignore # noqa: F401
...
class Owner(BaseModel):
    type: Annotated[str | None, Field(description="Always `user`", example="user")] = None
    object: Annotated[
        str | None,
        Field(
    ...
    role: Annotated[str | None, Field(description="Always `owner`", example="owner")] = None
...
class ApiKeyList(BaseModel):
    object: Annotated[str | None, Field(example="list")] = None
    data: list[AdminApiKey] | None = None
    has_more: Annotated[bool | None, Field(example=False)] = None
    first_id: Annotated[str | None, Field(example="key_abc")] = None
    last_id: Annotated[str | None, Field(example="key_xyz")] = None
...
class CodeInterpreterToolOutput(BaseModel):
    __root__: CodeInterpreterTextOutput | CodeInterpreterFileOutput
...
class ListCertificatesResponse(BaseModel):
    ...
    first_id: Annotated[str | None, Field(example="cert_abc")] = None
    last_id: Annotated[str | None, Field(example="cert_abc")] = None
    has_more: bool
    object: Literal["list"]
...
class Filters(BaseModel):
    __root__: ComparisonFilter | CompoundFilter
...
class AnnotationModel(BaseModel):
    __root__: Annotated[FileCitationBody | UrlCitationBody | FilePath, Field(discriminator="type")]
...
class ComputerAction(BaseModel):
    __root__: Click | DoubleClick | Drag | KeyPress | Move | Screenshot | Scroll | Type | Wait
...
class WebSearchOptions(BaseModel):
    ...
    search_context_size: Annotated[
        ...
        Field(default_factory=lambda: WebSearchContextSize.parse_obj("medium")),
    ]
...
class CreateChatCompletionResponse(BaseModel):
    ...
    service_tier: Annotated[
        ServiceTier | None, Field(default_factory=lambda: ServiceTier.parse_obj("auto"))
    ]
    system_fingerprint: Annotated[
        str | None,
        Field(
...
class CreateTranscriptionRequest(BaseModel):
    ...
    response_format: Annotated[
        ...
        Field(default_factory=lambda: AudioResponseFormat.parse_obj("json")),
    ]
    temperature: Annotated[
        float,
        Field(
...
class CreateTranscriptionResponseStreamEvent(BaseModel):
    __root__: Annotated[
        TranscriptTextDeltaEvent | TranscriptTextDoneEvent, Field(discriminator="type")
    ]
...
class InputContent(BaseModel):
    __root__: InputTextContent | InputImageContent | InputFileContent
...
class ListBatchesResponse(BaseModel):
    data: list[Batch]
    first_id: Annotated[str | None, Field(example="batch_abc123")] = None
    last_id: Annotated[str | None, Field(example="batch_abc456")] = None
    has_more: bool
    object: Literal["list"]
...
class OutputContent(BaseModel):
    __root__: OutputTextContent | RefusalContent
...
class Reasoning(BaseModel):
    effort: Annotated[
        ReasoningEffort | None,
        Field(default_factory=lambda: ReasoningEffort.parse_obj("medium")),
    ]
    summary: Annotated[
...
class CreateRunRequest(BaseModel):
    ...
    parallel_tool_calls: Annotated[
        ...
        Field(default_factory=lambda: ParallelToolCalls.parse_obj(True)),
    ]
    response_format: AssistantsApiResponseFormatOption | None = None
...
class ModelIds(BaseModel):
    __root__: ModelIdsShared | ModelIdsResponses
