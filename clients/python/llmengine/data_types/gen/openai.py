...
class Owner(BaseModel):
    type: Annotated[Optional[str], Field(description="Always `user`", example="user")] = None
    object: Annotated[
        Optional[str],
        Field(
    ...
    role: Annotated[Optional[str], Field(description="Always `owner`", example="owner")] = None
...
class AdminApiKey(BaseModel):
    ...
    name: Annotated[str, Field(description="The name of the API key", example="Administration Key")]
    redacted_value: Annotated[
        str,
        Field(description="The redacted value of the API key", example="sk-admin...def"),
    ]
    value: Annotated[
        Optional[str],
        Field(
...
class ChatCompletionRequestFunctionMessage(BaseModel):
    ...
    content: Annotated[Optional[str], Field(description="The contents of the function message.")]
    name: Annotated[str, Field(description="The name of the function to call.")]
...
class CodeInterpreterToolOutput(BaseModel):
    __root__: Union[CodeInterpreterTextOutput, CodeInterpreterFileOutput]
...
class Input4(BaseModel):
    ...
    text: Annotated[
        str,
        Field(description="A string of text to classify.", example="I want to kill them"),
    ]
...
class LearningRateMultiplier3(BaseModel):
    __root__: Annotated[
        float,
        Field(
            description="Scaling factor for the learning rate. A smaller learning rate may be useful to avoid\noverfitting.\n",
...
class VectorStoreFileContentResponse(BaseModel):
    ...
    next_page: Annotated[Optional[str], Field(description="The token for the next page, if any.")]
...
class AnnotationModel(BaseModel):
    __root__: Annotated[
        Union[FileCitationBody, UrlCitationBody, FilePath], Field(discriminator="type")
    ]
...
class ComputerAction(BaseModel):
    __root__: Union[Click, DoubleClick, Drag, KeyPress, Move, Screenshot, Scroll, Type, Wait]
...
class InputContent(BaseModel):
    __root__: Union[InputTextContent, InputImageContent, InputFileContent]
...
class OutputContent(BaseModel):
    __root__: Union[OutputTextContent, RefusalContent]
...
class FineTunePreferenceRequestInput(BaseModel):
    ...
    preferred_completion: Annotated[
        ...
        Field(description="The preferred completion message for the output.", max_items=1),
    ] = None
