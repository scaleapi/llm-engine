...
from spellbook_serve.common.dtos.model_endpoints import BrokerName, BrokerType
...
from spellbook_serve.common.resource_limits import (
    FORWARDER_CPU_USAGE,
    FORWARDER_MEMORY_USAGE,
    FORWARDER_STORAGE_USAGE,
)
from spellbook_serve.common.serialization_utils import bool_to_str, python_json_to_b64
...
def get_endpoint_resource_arguments_from_request(
    ...
    datadog_trace_enabled = "false" # TODO: Make datadog trace configurable
    ...
    if (
        ...
        infra_service_config_volume_mount_path = f"{flavor.env['BASE_PATH']}/ml_infra_core/spellbook_serve.core/spellbook_serve.core/configs"
