  ...
  "Statement": [
    {
      ...
      "Action": "sqs:*",
      "Resource": "arn:aws:sqs:us-west-2:692474966980:launch-endpoint-id-test_model_endpoint_id_3"
    },
    {
      "Effect": "Allow",
      "Principal": {
...
EXPECTED_QUEUE_TAGS = {
    ...
    "Launch-Endpoint-Id": "test_model_endpoint_id_3",
    "Launch-Endpoint-Name": "test_model_endpoint_name_3",
    "Launch-Endpoint-Created-By": "test_user_id",
}
...
def mock_create_async_sqs_client_create_queue():
    create_queue_response = {
        "QueueUrl": "https://us-west-2.queue.amazonaws.com/692474966980/launch-endpoint-id-test_model_endpoint_id_3",
        "ResponseMetadata": {
...
def mock_create_async_sqs_client_delete_queue():
    ...
    mock_sqs_client_session_val.get_queue_url.return_value = {
        "QueueUrl": "https://us-west-2.queue.amazonaws.com/692474966980/launch-endpoint-id-model_endpoint_id_1"
    }
...
def mock_create_async_sqs_client_get_queue_attributes():
    ...
    get_queue_attributes_response = {
        "Attributes": {
            "QueueArn": "arn:aws:sqs:us-west-2:692474966980:launch-endpoint-id-model_endpoint_id_1",
...
async def test_sqs_create_or_update_resources_endpoint_exists(
    ...
    expected_get_queue_url_args: Dict[str, Any] = {
        "QueueName": "launch-endpoint-id-test_model_endpoint_id_3",
    }
