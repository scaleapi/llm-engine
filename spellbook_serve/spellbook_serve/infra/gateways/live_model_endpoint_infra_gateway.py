...
from spellbook_serve.common.settings import (
...
from spellbook_serve.domain.gateways import TaskQueueGateway
from spellbook_serve.infra.gateways.model_endpoint_infra_gateway import ModelEndpointInfraGateway
from spellbook_serve.infra.gateways.resources.endpoint_resource_gateway import (
    EndpointResourceGateway,
)

BUILD_TASK_NAME = "spellbook_serve.service_builder.tasks_v1.build_endpoint"
