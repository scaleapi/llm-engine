...
from spellbook_serve.inference.forwarding.forwarding import LoadForwarder, LoadStreamingForwarder
...
def entrypoint():
    ...
    command = [
        ...
        *envs,
        "spellbook_serve.inference.forwarding.http_forwarder:app",
    ]
