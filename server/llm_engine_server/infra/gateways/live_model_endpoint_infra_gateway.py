...
from llm_engine_server.common.settings import (
...
from llm_engine_server.domain.gateways import TaskQueueGateway
from llm_engine_server.infra.gateways.model_endpoint_infra_gateway import ModelEndpointInfraGateway
from llm_engine_server.infra.gateways.resources.endpoint_resource_gateway import (
    EndpointResourceGateway,
)

BUILD_TASK_NAME = "llm_engine_server.service_builder.tasks_v1.build_endpoint"
