...
from llm_engine_server.domain.entities import CustomFramework, ModelBundleFrameworkType, OwnedEntity
from llm_engine_server.domain.entities.model_bundle_entity import RunnableImageLike
from llm_engine_server.domain.entities.model_endpoint_entity import ModelEndpointRecord

LLM_ENGINE_INTEGRATION_TEST_USER: str = "62bc820451dbea002b1c5421"
...
class ScaleAuthorizationModule:
    ...
    def check_access_create_bundle_v2(user: User, request: CreateModelBundleV2Request) -> bool:
        ...
        return (
            user.is_privileged_user
            or user.user_id == LLM_ENGINE_INTEGRATION_TEST_USER
            or (
