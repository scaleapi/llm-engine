...
class ModelVersion(Base):
    __table__ = Table(
        ...
        Column(
            "llm_engine_model_bundle_id",
            Text,
            # ForeignKey("llm_engine.bundles.id"), # This is currently breaking tests.
            index=True,
            nullable=True,
        ),
    ...
    def __init__(
        ...
        llm_engine_model_bundle_id: Optional[str] = None,
        ...
        self.llm_engine_model_bundle_id = llm_engine_model_bundle_id
    ...
    @staticmethod
    def select_by_llm_engine_model_bundle_id(
