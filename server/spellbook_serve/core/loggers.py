...
def loggers_at_level(*loggers_or_names, new_level: int) -> None:
    ...
    >>>> import logging
    >>>> from spellbook_serve.core.loggers import loggers_at_level, make_logger
    >>>>
    >>>> your_logger = make_logger('your_logger')
    >>>>
    >>>> with loggers_at_level(
    >>>>   your_logger,
    >>>>   'spellbook_serve.core.loggers',
    ...
    >>>>   logging.getLogger('spellbook_serve.core.loggers').warning("neither will this")
    >>>>
