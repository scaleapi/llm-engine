...
from spellbook_serve.db.base import Base
from spellbook_serve.db.models import *

SCHEMAS = ["spellbook_serve", "model"]


def init_database(database_url: str, psycopg_connection):
    assert "amazonaws" not in database_url, "Please do not run tests on the RDS instances."
