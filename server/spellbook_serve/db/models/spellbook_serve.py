...
class Endpoint(Base):
    ...
    current_bundle_id = Column(Text, ForeignKey("spellbook_serve.bundles.id"))
...
class BatchJob(Base):
    ...
    __table_args__ = ({"schema": "spellbook_serve"},)
    ...
    model_bundle_id = Column(
        Text, ForeignKey("spellbook_serve.bundles.id", ondelete="SET NULL"), nullable=False
    )
    model_endpoint_id = Column(Text, ForeignKey("spellbook_serve.endpoints.id"), nullable=True)
...
class Trigger(Base):
    ...
    docker_image_batch_job_bundle_id = Column(
        ...
        String,
        ForeignKey("spellbook_serve.docker_image_batch_job_bundles.id"),
        nullable=False,
    )
