...
__all__: Sequence[str] = ("GCPPubSubQueueEndpointResourceDelegate",)
...
class GCPPubSubQueueEndpointResourceDelegate(QueueEndpointResourceDelegate):
    def __init__(self, sqs_profile: Optional[str] = None):
    ...
    async def create_queue_if_not_exists(
        ...
        raise NotImplementedError("GCP pubsub is not implemented")
