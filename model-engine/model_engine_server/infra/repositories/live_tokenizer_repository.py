...
def get_default_supported_models_info() -> Dict[str, ModelInfo]:
    return {
        ...
        "llama-3-1-8b": ModelInfo("meta-llama/Meta-Llama-3.1-8B", None),
        "llama-3-1-8b-instruct": ModelInfo("meta-llama/Meta-Llama-3.1-8B-Instruct", None),
        "llama-3-1-70b": ModelInfo("meta-llama/Meta-Llama-3.1-70B", None),
        "llama-3-1-70b-instruct": ModelInfo("meta-llama/Meta-Llama-3.1-70B-Instruct", None),
        "llama-3-1-405b": ModelInfo("meta-llama/Meta-Llama-3.1-405B", None),
        "llama-3-1-405b-instruct": ModelInfo("meta-llama/Meta-Llama-3.1-405B-Instruct", None),
