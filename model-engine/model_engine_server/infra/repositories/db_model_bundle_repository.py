...
from model_engine_server.db.models import Bundle as OrmModelBundle
...
def translate_model_bundle_orm_to_model_bundle(
    ...
    kwargs = dict_not_none(
        ...
        flavor=dict_not_none(
            ...
            predict_route=model_bundle_orm.runnable_image_predict_route or "/predict",
            healthcheck_route=model_bundle_orm.runnable_image_healthcheck_route or "/readyz",
            ...
            routes=model_bundle_orm.runnable_image_routes or [],
            extra_routes=model_bundle_orm.runnable_image_extra_routes or [],
