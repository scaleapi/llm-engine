...
class CreateLLMModelBundleV1UseCase:
    ...
    def _create_vllm_bundle_command(
        ...
        if multinode and is_leader:
            ...
            vllm_cmd += "/workspace/init_ray.sh worker --ray_cluster_size=$RAY_CLUSTER_SIZE --ray_address=$K8S_LWS_LEADER_NAME.$K8S_LWS_NAME.$K8S_OWN_NAMESPACE.svc.cluster.local --own_address=$K8S_OWN_POD_NAME.$K8S_LWS_NAME.$K8S_OWN_NAMESPACE.svc.cluster.local"
