...
MODEL_CACHE_MOUNT_PATH: str = os.environ.get("MODEL_CACHE_MOUNT_PATH", "/mnt/model-cache")
...
MODEL_CACHE_LOCK_STALE_SECONDS: int = int(os.environ.get("MODEL_CACHE_LOCK_STALE_SECONDS", "600"))
