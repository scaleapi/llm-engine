...
ENDPOINT_GC_SCALE_TO_ZERO_TASK_ID_KEY: str = "_gc_scale_to_zero_task_id"
ENDPOINT_GC_SEEN_TASK_ID_KEY: str = "_gc_seen_task_id"
ENDPOINT_GC_SEEN_RESTART_AT_KEY: str = "_gc_seen_restart_at"
ENDPOINT_GC_PARKED_AT_KEY: str = "_gc_parked_at"
ENDPOINT_GC_OBSERVED_AT_KEY: str = "_gc_observed_at"
