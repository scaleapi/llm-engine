...
#   timestamp: 2026-01-10T00:37:52+00:00
...
class Owner(BaseModel):
    type: Annotated[Optional[str], Field(description="Always `user`", examples=["user"])] = None
    object: Annotated[
        Optional[str],
        Field(
    ...
    role: Annotated[Optional[str], Field(description="Always `owner`", examples=["owner"])] = None
...
class AdminApiKey(BaseModel):
    ...
    redacted_value: Annotated[
        str,
        Field(description="The redacted value of the API key", examples=["sk-admin...def"]),
    ]
    value: Annotated[
        Optional[str],
        Field(
...
class AudioResponseFormat(RootModel[Literal["json", "text", "srt", "verbose_json", "vtt"]]):
    root: Annotated[
...
class Data1(BaseModel):
    project_id: Annotated[
        Optional[str],
        Field(description="The ID of the project that the checkpoint permission was created for."),
    ] = None
...
class CheckpointPermissionCreated(BaseModel):
    id: Annotated[Optional[str], Field(description="The ID of the checkpoint permission.")] = None
    data: Annotated[
        Optional[Data1],
...
class Data2(BaseModel):
    email: Annotated[Optional[str], Field(description="The email invited to the organization.")] = (
        None
    )
    role: Annotated[
        Optional[str],
...
class InviteSent(BaseModel):
    ...
    data: Annotated[
        Optional[Data2], Field(description="The payload used to create the invite.")
    ] = None
...
class ProjectCreated(BaseModel):
    id: Annotated[Optional[str], Field(description="The project ID.")] = None
    data: Annotated[
        Optional[Data3], Field(description="The payload used to create the project.")
    ] = None
...
class ChangesRequested3(BaseModel):
    ...
    max_images_per_1_minute: Annotated[
        Optional[int],
        Field(description="The maximum images per minute. Only relevant for certain models."),
    ] = None
    ...
    max_requests_per_1_day: Annotated[
        Optional[int],
        Field(description="The maximum requests per day. Only relevant for certain models."),
    ] = None
...
class CertificateCreated(BaseModel):
    ...
    name: Annotated[Optional[str], Field(description="The name of the certificate.")] = None
...
class CertificateDetails(BaseModel):
    valid_at: Annotated[
        Optional[int],
        Field(description="The Unix timestamp (in seconds) of when the certificate becomes valid."),
    ] = None
    expires_at: Annotated[
        Optional[int],
        Field(description="The Unix timestamp (in seconds) of when the certificate expires."),
    ] = None
    content: Annotated[
        Optional[str],
...
class Certificate2(BaseModel):
    ...
    created_at: Annotated[
        int,
        Field(description="The Unix timestamp (in seconds) of when the certificate was uploaded."),
    ]
...
class Audio(BaseModel):
    id: Annotated[
        str,
        Field(description="Unique identifier for a previous audio response from the model.\n"),
    ]
...
class ChatCompletionRequestFunctionMessage(BaseModel):
    ...
    content: Annotated[
        Optional[str], Field(description="The contents of the function message.")
    ] = None
    name: Annotated[str, Field(description="The name of the function to call.")]
...
class ChatCompletionStreamResponseDelta(BaseModel):
    content: Annotated[Optional[str], Field(description="The contents of the chunk message.")] = (
        None
    )
    function_call: Annotated[
...
class ChatCompletionToolChoiceOption(
    RootModel[Union[Literal["none", "auto", "required"], ChatCompletionNamedToolChoice]]
):
    root: Annotated[
...
class CodeInterpreterFileOutput(BaseModel):
    type: Annotated[
        Literal["files"],
        Field(description="The type of the code interpreter file output. Always `files`.\n"),
    ]
    files: List[File1]
...
class CodeInterpreterTextOutput(BaseModel):
    type: Annotated[
        Literal["logs"],
        Field(description="The type of the code interpreter text output. Always `logs`.\n"),
    ]
...
class PromptTokensDetails(BaseModel):
    audio_tokens: Annotated[int, Field(description="Audio input tokens present in the prompt.")] = 0
    cached_tokens: Annotated[int, Field(description="Cached tokens present in the prompt.")] = 0
...
class CompoundFilter(BaseModel):
    ...
    filters: Annotated[
        List[Union[ComparisonFilter, Any]],
        Field(
...
class ComputerScreenshotImage(BaseModel):
    ...
    file_id: Annotated[
        Optional[str],
        Field(description="The identifier of an uploaded file that contains the screenshot."),
    ] = None
...
class ComputerToolCallSafetyCheck(BaseModel):
    ...
    message: Annotated[str, Field(description="Details about the pending safety check.")]
...
class Amount(BaseModel):
    value: Annotated[Optional[float], Field(description="The numeric value of the cost.")] = None
    currency: Annotated[
...
class Choice2(BaseModel):
    ...
    index: int
    logprobs: Annotated[Optional[Logprobs2], Field(...)]
    text: str
...
class InputMessages1(BaseModel):
    ...
    item_reference: Annotated[
        str,
        Field(description='A reference to a variable in the "item" namespace. Ie, "item.name"'),
    ]
...
class SamplingParams(BaseModel):
    ...
    seed: Annotated[
        int,
        Field(description="A seed value to initialize the randomness, during sampling."),
    ] = 42
...
class CreateEvalItem1(BaseModel):
    role: Annotated[
        str,
        Field(description='The role of the message (e.g. "system", "assistant", "user").'),
    ]
    content: Annotated[str, Field(description="The content of the message.")]


class CreateEvalLogsDataSourceConfig(BaseModel):
    type: Annotated[Literal["logs"], Field(description="The type of data source. Always `logs`.")]
    metadata: Annotated[
...
class Hyperparameters(BaseModel):
    ...
    learning_rate_multiplier: Annotated[
        Union[Literal["auto"], LearningRateMultiplier],
        Field(
            description="Scaling factor for the learning rate. A smaller learning rate may be useful to avoid\noverfitting.\n"
        ),
    ] = "auto"
...
class CreateImageEditRequest(BaseModel):
    ...
    model: Annotated[
        Optional[Union[Optional[str], Literal["dall-e-2", "gpt-image-1"]]],
        Field(
    ...
    size: Annotated[
        Optional[Literal["256x256", "512x512", "1024x1024", "1536x1024", "1024x1536", "auto"]],
        Field(
...
class CreateImageRequest(BaseModel):
    ...
    model: Annotated[
        Optional[Union[Optional[str], Literal["dall-e-2", "dall-e-3", "gpt-image-1"]]],
        Field(
...
class Input3(BaseModel):
    ...
    image_url: Annotated[
        ImageUrl1,
        Field(description="Contains either an image URL or a data URL for a base64 encoded image."),
    ]
...
class CreateModerationRequest(BaseModel):
    input: Annotated[
        Union[str, List[str], List[Union[Input3, Input4]]],
        Field(
...
class Logprob(BaseModel):
    token: Annotated[Optional[str], Field(description="The token in the transcription.")] = None
    logprob: Annotated[Optional[float], Field(description="The log probability of the token.")] = (
        None
    )
    bytes: Annotated[Optional[List[float]], Field(description="The bytes of the token.")] = None
...
class DeleteFineTuningCheckpointPermissionResponse(BaseModel):
    id: Annotated[
        str,
        Field(description="The ID of the fine-tuned model checkpoint permission that was deleted."),
    ]
    object: Annotated[
...
class Error1(BaseModel):
    code: Annotated[Optional[str], Field(...)] = None
    message: str
    param: Annotated[Optional[str], Field(...)] = None
    type: str
...
class InputItem1(BaseModel):
    role: Annotated[
        str,
        Field(description="The role of the message sender (e.g., system, user, developer)."),
    ]
    content: Annotated[str, Field(description="The content of the message.")]
...
class OutputItem(BaseModel):
    ...
    content: Annotated[Optional[str], Field(description="The content of the message.")] = None
...
class EvalRunOutputItem(BaseModel):
    ...
    run_id: Annotated[
        str,
        Field(description="The identifier of the evaluation run associated with this output item."),
    ]
    eval_id: Annotated[str, Field(description="The identifier of the evaluation group.")]
    created_at: Annotated[
        int,
        Field(description="Unix timestamp (in seconds) when the evaluation run was created."),
    ]
    ...
    sample: Annotated[
        Sample,
        Field(description="A sample containing the input and output of the evaluation run."),
    ]
...
class EvalRunOutputItemList(BaseModel):
    ...
    first_id: Annotated[
        str,
        Field(description="The identifier of the first eval run output item in the data array."),
    ]
    last_id: Annotated[
        str,
        Field(description="The identifier of the last eval run output item in the data array."),
    ]
    has_more: Annotated[
        bool,
        Field(description="Indicates whether there are more eval run output items available."),
    ]
...
class EvalTextSimilarityGrader(BaseModel):
    type: Annotated[Literal["text_similarity"], Field(description="The type of grader.")]
    name: Annotated[Optional[str], Field(description="The name of the grader.")] = None
...
class Hyperparameters1(BaseModel):
    ...
    learning_rate_multiplier: Annotated[
        Union[Literal["auto"], LearningRateMultiplier1],
        Field(
            description="Scaling factor for the learning rate. A smaller learning rate may be useful to avoid overfitting.\n"
        ),
    ] = "auto"
...
class FineTuningCheckpointPermission(BaseModel):
    ...
    created_at: Annotated[
        int,
        Field(description="The Unix timestamp (in seconds) for when the permission was created."),
    ]
    project_id: Annotated[
...
class Hyperparameters3(BaseModel):
    batch_size: Annotated[
        Union[Literal["auto"], BatchSize3],
        Field(
            description="Number of examples in each batch. A larger batch size means that model parameters\nare updated less frequently, but with lower variance.\n"
        ),
    ] = "auto"
    learning_rate_multiplier: Annotated[
        Union[Literal["auto"], LearningRateMultiplier3],
        Field(
            description="Scaling factor for the learning rate. A smaller learning rate may be useful to avoid\noverfitting.\n"
        ),
    ] = "auto"
    n_epochs: Annotated[
        Union[Literal["auto"], NEpochs3],
        Field(
            description="The number of epochs to train the model for. An epoch refers to one full cycle\nthrough the training dataset.\n"
        ),
    ] = "auto"
...
class Usage2(BaseModel):
    ...
    input_tokens: Annotated[
        int,
        Field(description="The number of tokens (images and text) in the input prompt."),
    ]
    ...
    input_tokens_details: Annotated[
        InputTokensDetails,
        Field(description="The input tokens detailed information for the image generation."),
    ]
...
class ImagesResponse(BaseModel):
    created: Annotated[
        int,
        Field(description="The Unix timestamp (in seconds) of when the image was created."),
    ]
    data: Annotated[Optional[List[Image1]], Field(description="The list of generated images.")] = (
        None
    )
    usage: Annotated[
        Optional[Usage2],
...
class OpenAIFile(BaseModel):
    ...
    expires_at: Annotated[
        Optional[int],
        Field(description="The Unix timestamp (in seconds) for when the file will expire."),
    ] = None
...
class ProjectRateLimit(BaseModel):
    ...
    max_images_per_1_minute: Annotated[
        Optional[int],
        Field(description="The maximum images per minute. Only present for relevant models."),
    ] = None
    max_audio_megabytes_per_1_minute: Annotated[
        Optional[int],
        Field(
    ...
    max_requests_per_1_day: Annotated[
        Optional[int],
        Field(description="The maximum requests per day. Only present for relevant models."),
    ] = None
    batch_1_day_max_input_tokens: Annotated[
        Optional[int],
        Field(
...
class RealtimeClientEventConversationItemDelete(BaseModel):
    ...
    type: Annotated[
        Literal["RealtimeClientEventConversationItemDelete"],
...
class RealtimeClientEventConversationItemRetrieve(BaseModel):
    ...
    type: Annotated[
        Literal["RealtimeClientEventConversationItemRetrieve"],
...
class RealtimeClientEventConversationItemTruncate(BaseModel):
    ...
    type: Annotated[
        Literal["RealtimeClientEventConversationItemTruncate"],
...
class RealtimeClientEventInputAudioBufferAppend(BaseModel):
    ...
    type: Annotated[
        Literal["RealtimeClientEventInputAudioBufferAppend"],
...
class RealtimeClientEventInputAudioBufferClear(BaseModel):
    ...
    type: Annotated[
        Literal["RealtimeClientEventInputAudioBufferClear"],
...
class RealtimeClientEventInputAudioBufferCommit(BaseModel):
    ...
    type: Annotated[
        Literal["RealtimeClientEventInputAudioBufferCommit"],
...
class RealtimeClientEventOutputAudioBufferClear(BaseModel):
    ...
    type: Annotated[
        Literal["RealtimeClientEventOutputAudioBufferClear"],
...
class RealtimeClientEventResponseCancel(BaseModel):
    ...
    type: Annotated[
        Literal["RealtimeClientEventResponseCancel"],
...
class ContentItem1(BaseModel):
    type: Annotated[
        Optional[Literal["input_audio", "input_text", "item_reference", "text"]],
        Field(
    ...
    text: Annotated[
        Optional[str],
        Field(description="The text content, used for `input_text` and `text` content types.\n"),
    ] = None
    id: Annotated[
        Optional[str],
        Field(
    ...
    audio: Annotated[
        Optional[str],
        Field(description="Base64-encoded audio bytes, used for `input_audio` content type.\n"),
    ] = None
    transcript: Annotated[
        Optional[str],
        Field(description="The transcript of the audio, used for `input_audio` content type.\n"),
    ] = None
...
class RealtimeConversationItem(BaseModel):
    ...
    type: Annotated[
        Optional[Literal["message", "function_call", "function_call_output"]],
        Field(
    ...
    status: Annotated[
        Optional[Literal["completed", "incomplete"]],
        Field(
    ...
    name: Annotated[
        Optional[str],
        Field(description="The name of the function being called (for `function_call` items).\n"),
    ] = None
    arguments: Annotated[
        Optional[str],
        Field(description="The arguments of the function call (for `function_call` items).\n"),
    ] = None
    output: Annotated[
        Optional[str],
        Field(description="The output of the function call (for `function_call_output` items).\n"),
    ] = None
...
class StatusDetails(BaseModel):
    type: Annotated[
        Optional[Literal["completed", "cancelled", "failed", "incomplete"]],
        Field(
...
class Conversation(BaseModel):
    id: Annotated[Optional[str], Field(description="The unique ID of the conversation.")] = None
    object: Annotated[
        Optional[str],
...
class RealtimeServerEventConversationCreated(BaseModel):
    ...
    type: Annotated[
        Literal["RealtimeServerEventConversationCreated"],
...
class RealtimeServerEventConversationItemCreated(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventConversationItemCreated"],
...
class RealtimeServerEventConversationItemDeleted(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventConversationItemDeleted"],
...
class RealtimeServerEventConversationItemInputAudioTranscriptionCompleted(BaseModel):
    ...
    logprobs: Annotated[
        Optional[List[LogProbProperties]],
...
class RealtimeServerEventConversationItemInputAudioTranscriptionDelta(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventConversationItemInputAudioTranscriptionDelta"],
        Field(
...
class RealtimeServerEventConversationItemRetrieved(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventConversationItemRetrieved"],
...
class RealtimeServerEventConversationItemTruncated(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventConversationItemTruncated"],
...
class RealtimeServerEventError(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventError"],
        Field(description="The event type, must be `error`."),
    ]
...
class RealtimeServerEventInputAudioBufferCleared(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventInputAudioBufferCleared"],
...
class RealtimeServerEventInputAudioBufferCommitted(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventInputAudioBufferCommitted"],
...
class RealtimeServerEventInputAudioBufferSpeechStarted(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventInputAudioBufferSpeechStarted"],
...
class RealtimeServerEventInputAudioBufferSpeechStopped(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventInputAudioBufferSpeechStopped"],
...
class RealtimeServerEventOutputAudioBufferCleared(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventOutputAudioBufferCleared"],
...
class RealtimeServerEventOutputAudioBufferStarted(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventOutputAudioBufferStarted"],
...
class RealtimeServerEventOutputAudioBufferStopped(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventOutputAudioBufferStopped"],
...
class RealtimeServerEventRateLimitsUpdated(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventRateLimitsUpdated"],
...
class RealtimeServerEventResponseAudioDelta(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventResponseAudioDelta"],
...
class RealtimeServerEventResponseAudioDone(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventResponseAudioDone"],
...
class RealtimeServerEventResponseAudioTranscriptDelta(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventResponseAudioTranscriptDelta"],
...
class RealtimeServerEventResponseAudioTranscriptDone(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventResponseAudioTranscriptDone"],
...
class Part(BaseModel):
    type: Annotated[
        Optional[Literal["audio", "text"]],
        Field(description='The content type ("text", "audio").'),
    ] = None
    text: Annotated[Optional[str], Field(description='The text content (if type is "text").')] = (
        None
    )
    audio: Annotated[
        Optional[str],
...
class RealtimeServerEventResponseContentPartAdded(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventResponseContentPartAdded"],
...
class RealtimeServerEventResponseContentPartDone(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventResponseContentPartDone"],
...
class RealtimeServerEventResponseFunctionCallArgumentsDelta(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventResponseFunctionCallArgumentsDelta"],
...
class RealtimeServerEventResponseFunctionCallArgumentsDone(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventResponseFunctionCallArgumentsDone"],
...
class RealtimeServerEventResponseOutputItemAdded(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventResponseOutputItemAdded"],
...
class RealtimeServerEventResponseOutputItemDone(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventResponseOutputItemDone"],
...
class RealtimeServerEventResponseTextDelta(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventResponseTextDelta"],
...
class RealtimeServerEventResponseTextDone(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventResponseTextDone"],
...
class InputAudioNoiseReduction(BaseModel):
    type: Annotated[
        Optional[Literal["near_field", "far_field"]],
        Field(
...
class InputAudioTranscription3(BaseModel):
    model: Annotated[
        Optional[Literal["gpt-4o-transcribe", "gpt-4o-mini-transcribe", "whisper-1"]],
        Field(
            description="The model to use for transcription, current options are `gpt-4o-transcribe`, `gpt-4o-mini-transcribe`, and `whisper-1`.\n"
        ),
    ] = None
...
class RealtimeTranscriptionSessionCreateRequest(BaseModel):
    ...
    input_audio_transcription: Annotated[
        Optional[InputAudioTranscription3],
        Field(
...
class RealtimeTranscriptionSessionCreateResponse(BaseModel):
    ...
    input_audio_transcription: Annotated[
        Optional[InputAudioTranscription4],
...
class ReasoningEffort(RootModel[Optional[Literal["low", "medium", "high"]]]):
    root: Annotated[
...
class ReasoningItem(BaseModel):
    ...
    summary: Annotated[List[SummaryItem], Field(description="Reasoning text contents.\n")]
    status: Annotated[
        Optional[Literal["in_progress", "completed", "incomplete"]],
        Field(
            description="The status of the item. One of `in_progress`, `completed`, or\n`incomplete`. Populated when items are returned via API.\n"
...
class ResponseAudioTranscriptDeltaEvent(BaseModel):
    type: Annotated[
        ...
        Field(description="The type of the event. Always `response.audio.transcript.delta`.\n"),
    ]
...
class ResponseAudioTranscriptDoneEvent(BaseModel):
    type: Annotated[
        ...
        Field(description="The type of the event. Always `response.audio.transcript.done`.\n"),
    ]
...
class ResponseErrorEvent(BaseModel):
    ...
    code: Annotated[Optional[str], Field(description="The error code.\n")] = None
    message: Annotated[str, Field(description="The error message.\n")]
    param: Annotated[Optional[str], Field(description="The error parameter.\n")] = None


class ResponseFileSearchCallCompletedEvent(BaseModel):
    type: Annotated[
        Literal["ResponseFileSearchCallCompletedEvent"],
        Field(description="The type of the event. Always `response.file_search_call.completed`.\n"),
    ]
    output_index: Annotated[
        int,
        Field(description="The index of the output item that the file search call is initiated.\n"),
    ]
    item_id: Annotated[
        str,
        Field(description="The ID of the output item that the file search call is initiated.\n"),
    ]
...
class ResponseFileSearchCallSearchingEvent(BaseModel):
    type: Annotated[
        ...
        Field(description="The type of the event. Always `response.file_search_call.searching`.\n"),
    ]
    output_index: Annotated[
        int,
        Field(description="The index of the output item that the file search call is searching.\n"),
    ]
    item_id: Annotated[
        str,
        Field(description="The ID of the output item that the file search call is initiated.\n"),
...
class ResponseFormatJsonObject(BaseModel):
    type: Annotated[
        Literal["json_object"],
        Field(description="The type of response format being defined. Always `json_object`."),
    ]
...
class ResponseReasoningSummaryPartAddedEvent(BaseModel):
    ...
    output_index: Annotated[
        int,
        Field(description="The index of the output item this summary part is associated with.\n"),
    ]
...
class ResponseReasoningSummaryTextDeltaEvent(BaseModel):
    ...
    item_id: Annotated[
        str,
        Field(description="The ID of the item this summary text delta is associated with.\n"),
    ]
    output_index: Annotated[
        int,
        Field(
...
class ResponseReasoningSummaryTextDoneEvent(BaseModel):
    ...
    output_index: Annotated[
        int,
        Field(description="The index of the output item this summary text is associated with.\n"),
    ]
    summary_index: Annotated[
        int,
        Field(description="The index of the summary part within the reasoning summary.\n"),
...
class ResponseRefusalDeltaEvent(BaseModel):
    ...
    item_id: Annotated[
        str,
        Field(description="The ID of the output item that the refusal text is added to.\n"),
    ]
    output_index: Annotated[
        int,
        Field(description="The index of the output item that the refusal text is added to.\n"),
    ]
    content_index: Annotated[
        int,
        Field(description="The index of the content part that the refusal text is added to.\n"),
    ]
...
class ResponseRefusalDoneEvent(BaseModel):
    ...
    item_id: Annotated[
        str,
        Field(description="The ID of the output item that the refusal text is finalized.\n"),
    ]
    output_index: Annotated[
        int,
        Field(description="The index of the output item that the refusal text is finalized.\n"),
    ]
    content_index: Annotated[
        int,
        Field(description="The index of the content part that the refusal text is finalized.\n"),
    ]
...
class ResponseTextDeltaEvent(BaseModel):
    type: Annotated[
        ...
        Field(description="The type of the event. Always `response.output_text.delta`.\n"),
    ]
    item_id: Annotated[
        str,
        Field(description="The ID of the output item that the text delta was added to.\n"),
    ]
    output_index: Annotated[
        int,
        Field(description="The index of the output item that the text delta was added to.\n"),
    ]
    content_index: Annotated[
        int,
        Field(description="The index of the content part that the text delta was added to.\n"),
    ]
...
class ResponseTextDoneEvent(BaseModel):
    ...
    item_id: Annotated[
        str,
        Field(description="The ID of the output item that the text content is finalized.\n"),
    ]
    output_index: Annotated[
        int,
        Field(description="The index of the output item that the text content is finalized.\n"),
    ]
    content_index: Annotated[
        int,
        Field(description="The index of the content part that the text content is finalized.\n"),
    ]
...
class ResponseWebSearchCallCompletedEvent(BaseModel):
    ...
    item_id: Annotated[
        str,
        Field(description="Unique ID for the output item associated with the web search call.\n"),
    ]
...
class ResponseWebSearchCallSearchingEvent(BaseModel):
    type: Annotated[
        ...
        Field(description="The type of the event. Always `response.web_search_call.searching`.\n"),
    ]
    output_index: Annotated[
        int,
        Field(
...
class ContentItem3(BaseModel):
    type: Annotated[Optional[Literal["text"]], Field(description="The type of the content.")] = None
    text: Annotated[Optional[str], Field(description="The text content of the file.")] = None
...
class ServiceTier(RootModel[Optional[Literal["auto", "default", "flex"]]]):
    root: Annotated[
        Optional[Literal["auto", "default", "flex"]],
        Field(
...
class TextResponseFormatJsonSchema(BaseModel):
    type: Annotated[
        Literal["json_schema"],
        Field(description="The type of response format being defined. Always `json_schema`."),
    ]
    description: Annotated[
        Optional[str],
        Field(
...
class Upload(BaseModel):
    ...
    expires_at: Annotated[
        int,
        Field(description="The Unix timestamp (in seconds) for when the Upload will expire."),
    ]
    object: Annotated[
...
class UploadCertificateRequest(BaseModel):
    name: Annotated[Optional[str], Field(description="An optional name for the certificate")] = None
...
class VectorStoreFileAttributes(
    ...
    root: Optional[Dict[str, Union[VectorStoreFileAttributes1, float, bool]]] = None
...
class VectorStoreFileContentResponse(BaseModel):
    object: Annotated[
        ...
        Field(description="The object type, which is always `vector_store.file_content.page`"),
    ]
    ...
    next_page: Annotated[
        Optional[str], Field(description="The token for the next page, if any.")
    ] = None
...
class QueryItem(RootModel[str]):
    root: Annotated[str, Field(description="A list of queries to search for.", min_length=1)]
...
class VectorStoreSearchRequest(BaseModel):
    ...
    query: Annotated[Union[str, List[QueryItem]], Field(description="A query string for a search")]
    rewrite_query: Annotated[
        bool,
        Field(description="Whether to rewrite the natural language query for vector search."),
    ] = False
...
class SearchQueryItem(RootModel[str]):
    root: Annotated[str, Field(description="The query used for this search.", min_length=1)]
...
class VectorStoreSearchResultsPage(BaseModel):
    ...
    object: Annotated[
        ...
        Field(description="The object type, which is always `vector_store.search_results.page`"),
    ]
...
class WebSearchLocation(BaseModel):
    ...
    region: Annotated[
        Optional[str],
        Field(description="Free text input for the region of the user, e.g. `California`.\n"),
    ] = None
    city: Annotated[
        Optional[str],
        Field(description="Free text input for the city of the user, e.g. `San Francisco`.\n"),
    ] = None
    timezone: Annotated[
        Optional[str],
        Field(
...
class WebSearchToolCall(BaseModel):
    ...
    type: Annotated[
        ...
        Field(description="The type of the web search tool call. Always `web_search_call`.\n"),
    ]
    status: Annotated[
...
class ComputerUsePreviewTool(BaseModel):
    type: Annotated[
        ...
        Field(description="The type of the computer use tool. Always `computer_use_preview`."),
    ]
...
class ToolModel(
    RootModel[Union[FileSearchTool, FunctionTool, WebSearchPreviewTool, ComputerUsePreviewTool]]
):
    root: Annotated[
...
class AnnotationModel(RootModel[Union[FileCitationBody, UrlCitationBody, FilePath]]):
    root: Annotated[Union[FileCitationBody, UrlCitationBody, FilePath], Field(discriminator="type")]
...
class ChatCompletionMessageList(BaseModel):
    ...
    first_id: Annotated[
        str,
        Field(description="The identifier of the first chat message in the data array."),
    ]
    last_id: Annotated[
        str,
...
class ComputerAction(
    RootModel[Union[Click, DoubleClick, Drag, KeyPress, Move, Screenshot, Scroll, Type, Wait]]
):
    root: Union[Click, DoubleClick, Drag, KeyPress, Move, Screenshot, Scroll, Type, Wait]
...
class ComputerToolCall(BaseModel):
    ...
    call_id: Annotated[
        str,
        Field(description="An identifier used when responding to the tool call with output.\n"),
    ]
...
class ComputerToolCallOutput(BaseModel):
    ...
    call_id: Annotated[
        str,
        Field(description="The ID of the computer tool call that produced the output.\n"),
    ]
    acknowledged_safety_checks: Annotated[
        Optional[List[ComputerToolCallSafetyCheck]],
        Field(
...
class CreateEvalJsonlRunDataSource(BaseModel):
    type: Annotated[Literal["jsonl"], Field(description="The type of data source. Always `jsonl`.")]
...
class CreateTranscriptionRequest(BaseModel):
    ...
    model: Annotated[
        Union[str, Literal["whisper-1", "gpt-4o-transcribe", "gpt-4o-mini-transcribe"]],
        Field(
...
class CreateTranscriptionResponseStreamEvent(
    ...
    root: Annotated[
        Union[TranscriptTextDeltaEvent, TranscriptTextDoneEvent],
        Field(discriminator="type"),
    ]
...
class EvalItem(BaseModel):
    ...
    content: Annotated[
        Union[str, InputTextContent, Content7],
...
class EvalLabelModelGrader(BaseModel):
    ...
    model: Annotated[
        str,
        Field(description="The model to use for the evaluation. Must support structured outputs."),
    ]
    input: List[EvalItem]
    labels: Annotated[
        List[str],
    ...
    passing_labels: Annotated[
        List[str],
        Field(description="The labels that indicate a passing result. Must be a subset of labels."),
    ]
...
class EvalStoredCompletionsSource(BaseModel):
    ...
    created_after: Annotated[
        Optional[int],
        Field(description="An optional Unix timestamp to filter items created after this time."),
    ] = None
    created_before: Annotated[
        Optional[int],
        Field(description="An optional Unix timestamp to filter items created before this time."),
    ] = None
    limit: Annotated[
        Optional[int],
        Field(description="An optional maximum number of items to return."),
    ] = None


class Result1(BaseModel):
    file_id: Annotated[Optional[str], Field(description="The unique ID of the file.\n")] = None
    text: Annotated[
    ...
    score: Annotated[
        Optional[float],
        Field(description="The relevance score of the file - a value between 0 and 1.\n"),
    ] = None
...
class FileSearchToolCall(BaseModel):
    ...
    type: Annotated[
        ...
        Field(description="The type of the file search tool call. Always `file_search_call`.\n"),
    ]
    status: Annotated[
...
class FineTuneMethod(BaseModel):
    type: Annotated[
        Optional[Literal["supervised", "dpo"]],
...
class InputContent(RootModel[Union[InputTextContent, InputImageContent, InputFileContent]]):
...
class ProjectApiKey(BaseModel):
    ...
    last_used_at: Annotated[
        int,
        Field(description="The Unix timestamp (in seconds) of when the API key was last used."),
    ]
    id: Annotated[
        str,
        Field(description="The identifier, which can be referenced in API endpoints"),
...
class RealtimeClientEventConversationItemCreate(BaseModel):
    ...
    type: Annotated[
        Literal["RealtimeClientEventConversationItemCreate"],
...
class RealtimeClientEventTranscriptionSessionUpdate(BaseModel):
    ...
    type: Annotated[
        Literal["RealtimeClientEventTranscriptionSessionUpdate"],
...
class RealtimeResponse(BaseModel):
    id: Annotated[Optional[str], Field(description="The unique ID of the response.")] = None
    object: Annotated[
        Optional[Literal["realtime.response"]],
...
class RealtimeResponseCreateParams(BaseModel):
    ...
    metadata: Optional[Metadata] = None
    input: Annotated[
        Optional[List[RealtimeConversationItemWithReference]],
        Field(
...
class RealtimeServerEventResponseCreated(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventResponseCreated"],
...
class RealtimeServerEventResponseDone(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventResponseDone"],
...
class RealtimeServerEventTranscriptionSessionUpdated(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventTranscriptionSessionUpdated"],
...
class RealtimeSessionCreateResponse(BaseModel):
    ...
    input_audio_transcription: Annotated[
        Optional[InputAudioTranscription2],
        Field(
...
class ResponseContentPartAddedEvent(BaseModel):
    ...
    item_id: Annotated[
        str,
        Field(description="The ID of the output item that the content part was added to.\n"),
    ]
    output_index: Annotated[
        int,
        Field(description="The index of the output item that the content part was added to.\n"),
    ]
    content_index: Annotated[
...
class ResponseContentPartDoneEvent(BaseModel):
    type: Annotated[
        ...
        Field(description="The type of the event. Always `response.content_part.done`.\n"),
    ]
    item_id: Annotated[
        str,
        Field(description="The ID of the output item that the content part was added to.\n"),
...
class ResponseTextAnnotationDeltaEvent(BaseModel):
    type: Annotated[
        Literal["ResponseTextAnnotationDeltaEvent"],
        Field(
    ...
    item_id: Annotated[
        str,
        Field(description="The ID of the output item that the text annotation was added to.\n"),
    ]
    output_index: Annotated[
        int,
        Field(description="The index of the output item that the text annotation was added to.\n"),
    ]
    content_index: Annotated[
        int,
        Field(description="The index of the content part that the text annotation was added to.\n"),
    ]
...
class TextResponseFormatConfiguration(
    RootModel[Union[ResponseFormatText, TextResponseFormatJsonSchema, ResponseFormatJsonObject]]
):
    root: Annotated[
...
class ChatCompletionList(BaseModel):
    ...
    first_id: Annotated[
        str,
        Field(description="The identifier of the first chat completion in the data array."),
    ]
    last_id: Annotated[
        str,
        Field(description="The identifier of the last chat completion in the data array."),
    ]
    has_more: Annotated[
        bool,
        Field(description="Indicates whether there are more Chat Completions available."),
    ]


class Content(RootModel[Optional[List[ChatCompletionRequestAssistantMessageContentPart]]]):
    root: Annotated[
...
class ChatCompletionRequestAssistantMessage(BaseModel):
    content: Annotated[
        Optional[Union[Optional[str], Content]],
        Field(
...
class CreateEvalRequest(BaseModel):
    name: Annotated[Optional[str], Field(description="The name of the evaluation.")] = None
    metadata: Optional[Metadata] = None
    data_source_config: Annotated[
        Union[CreateEvalCustomDataSourceConfig, CreateEvalLogsDataSourceConfig],
        Field(description="The configuration for the data source used for the evaluation runs."),
    ]
...
class CreateEvalResponsesRunDataSource(BaseModel):
    ...
    input_messages: Optional[Union[InputMessages2, InputMessages1]] = None
    ...
    source: Union[EvalJsonlFileContentSource, EvalJsonlFileIdSource, EvalResponsesSource]
...
class Eval(BaseModel):
    ...
    data_source_config: Annotated[
        Union[EvalCustomDataSourceConfig, EvalStoredCompletionsDataSourceConfig],
        Field(description="Configuration of data sources used in runs of the evaluation."),
    ]
    testing_criteria: Annotated[
        List[
            Union[
    ...
    created_at: Annotated[
        int,
        Field(description="The Unix timestamp (in seconds) for when the eval was created."),
    ]
    metadata: Metadata
...
class FineTunePreferenceRequestInput(BaseModel):
    ...
    preferred_completion: Annotated[
        ...
        Field(description="The preferred completion message for the output.", max_length=1),
    ] = None
...
class RealtimeClientEventResponseCreate(BaseModel):
    ...
    type: Annotated[
        Literal["RealtimeClientEventResponseCreate"],
...
class RealtimeClientEventSessionUpdate(BaseModel):
    ...
    type: Annotated[
        Literal["RealtimeClientEventSessionUpdate"],
...
class RealtimeServerEventSessionCreated(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventSessionCreated"],
...
class RealtimeServerEventSessionUpdated(BaseModel):
    event_id: Annotated[str, Field(description="The unique ID of the server event.")]
    type: Annotated[
        Literal["RealtimeServerEventSessionUpdated"],
...
class ResponseOutputItemAddedEvent(BaseModel):
    type: Annotated[
        ...
        Field(description="The type of the event. Always `response.output_item.added`.\n"),
    ]
    output_index: Annotated[
...
class ResponseProperties(BaseModel):
    ...
    tool_choice: Annotated[
        Optional[Union[ToolChoiceOptions, ToolChoiceTypes, ToolChoiceFunction]],
        Field(
...
class CreateChatCompletionRequest(CreateModelResponseProperties):
    ...
    response_format: Annotated[
        Optional[Union[ResponseFormatText, ResponseFormatJsonSchema, ResponseFormatJsonObject]],
        Field(
...
class CreateEvalCompletionsRunDataSource(BaseModel):
    ...
    source: Union[EvalJsonlFileContentSource, EvalJsonlFileIdSource, EvalStoredCompletionsSource]
...
class EvalRun(BaseModel):
    ...
    report_url: Annotated[
        str,
        Field(description="The URL to the rendered evaluation run report on the UI dashboard."),
    ]
    ...
    per_testing_criteria_results: Annotated[
        ...
        Field(description="Results per testing criteria applied during the evaluation run."),
    ]
    data_source: Annotated[
        Union[
            CreateEvalJsonlRunDataSource,
...
class InputItem(RootModel[Union[EasyInputMessage, Item, ItemReferenceParam]]):
    root: Annotated[Union[EasyInputMessage, Item, ItemReferenceParam], Field()]
...
class Response1(ModelResponseProperties, ResponseProperties):
    ...
    object: Annotated[
        Literal["response"],
        Field(description="The object type of this resource - always set to `response`.\n"),
    ]
    status: Annotated[
        Optional[Literal["completed", "failed", "in_progress", "incomplete"]],
        Field(
    ...
    created_at: Annotated[
        float,
        Field(description="Unix timestamp (in seconds) of when this Response was created.\n"),
    ]
    error: ResponseError
    incomplete_details: Annotated[
        Optional[IncompleteDetails1],
    ...
    parallel_tool_calls: Annotated[
        bool,
        Field(description="Whether to allow the model to run tool calls in parallel.\n"),
    ]
...
class CreateResponse(CreateModelResponseProperties, ResponseProperties):
    input: Annotated[
        Union[str, List[InputItem]],
        Field(
            description="Text, image, or file inputs to the model, used to generate a response.\n\nLearn more:\n- [Text inputs and outputs](/docs/guides/text)\n- [Image inputs](/docs/guides/images)\n- [File inputs](/docs/guides/pdf-files)\n- [Conversation state](/docs/guides/conversation-state)\n- [Function calling](/docs/guides/function-calling)\n"
        ),
    ]
    include: Annotated[
        Optional[List[Includable]],
        Field(
            description="Specify additional output data to include in the model response. Currently\nsupported values are:\n- `file_search_call.results`: Include the search results of\n  the file search tool call.\n- `message.input_image.image_url`: Include image urls from the input message.\n- `computer_call_output.output.image_url`: Include image urls from the computer call output.\n"
        ),
    ] = None
