...
#   timestamp: 2025-12-02T21:52:14+00:00
...
class Owner(BaseModel):
    type: Annotated[
        Optional[str], Field(description='Always `user`', examples=['user'])
    ] = None
    object: Annotated[
        Optional[str],
        Field(
    ...
    role: Annotated[
        Optional[str], Field(description='Always `owner`', examples=['owner'])
    ] = None
...
class ApiKeyList(BaseModel):
    object: Annotated[Optional[str], Field(examples=['list'])] = None
    data: Optional[List[AdminApiKey]] = None
    has_more: Annotated[Optional[bool], Field(examples=[False])] = None
    first_id: Annotated[Optional[str], Field(examples=['key_abc'])] = None
    last_id: Annotated[Optional[str], Field(examples=['key_xyz'])] = None
...
class AssignedRoleDetails(BaseModel):
    ...
    description: Annotated[
        Optional[str], Field(description='Description of the role.')
    ] = None
    created_at: Annotated[
...
class ChatCompletionMessageToolCalls1(
    RootModel[Union[ChatCompletionMessageToolCall, ChatCompletionMessageCustomToolCall]]
):
    root: Annotated[
...
class ChatCompletionModalities(RootModel[Optional[List[Literal['text', 'audio']]]]):
    root: Optional[List[Literal['text', 'audio']]]
...
class ChatCompletionStreamOptions(RootModel[Optional[ChatCompletionStreamOptions1]]):
    root: Optional[ChatCompletionStreamOptions1]
...
class ContainerFileResource(BaseModel):
    ...
    object: Annotated[
        Literal['container.file'],
        Field(description='The type of this object (`container.file`).'),
    ]
...
class Tools1(RootModel[Union[AssistantToolsCode, AssistantToolsFileSearchTypeOnly]]):
    root: Annotated[
...
class Categories(BaseModel):
    ...
    illicit_violent: Annotated[Optional[bool], Field(alias='illicit/violent')] = None
    self_harm: Annotated[
        bool,
        Field(
            alias='self-harm',
...
class CreatedAfter(RootModel[int]):
    root: Annotated[
        int,
        Field(
...
class CreatedBefore(RootModel[int]):
    root: Annotated[
        int,
        Field(
...
class BatchSize4(RootModel[int]):
    root: Annotated[
        int,
        Field(
            description='Number of examples in each batch. A larger batch size means that model parameters\nare updated less frequently, but with lower variance.\n',
...
class Integrations1(RootModel[FineTuningIntegration]):
    root: Annotated[FineTuningIntegration, Field(discriminator='type')]


class Integrations(RootModel[List[Integrations1]]):
    root: Annotated[
        List[Integrations1],
        Field(
...
class MaxCompletionsTokens(RootModel[int]):
    root: Annotated[
        int,
        Field(
...
class ListCertificatesResponse(BaseModel):
    ...
    first_id: Annotated[Optional[str], Field(examples=['cert_abc'])] = None
    last_id: Annotated[Optional[str], Field(examples=['cert_abc'])] = None
    has_more: bool
    object: Literal['list']
...
class Temperature2(RootModel[float]):
    root: Annotated[
        float,
        Field(
...
class Temperature3(RootModel[float]):
    root: Annotated[
        float,
        Field(
            description='What sampling temperature to use, between 0 and 2. Higher values like 0.8 will make the output more random, while lower values like 0.2 will make it more focused and deterministic.\n',
...
class PartialImages1(RootModel[int]):
    root: Annotated[
        int,
        Field(
...
class PartialImages(RootModel[Optional[PartialImages1]]):
...
class RealtimeTruncation(
    RootModel[Union[Literal['auto', 'disabled'], RealtimeTruncation1]]
):
    root: Annotated[
...
class RealtimeTurnDetection(
    RootModel[Optional[Union[RealtimeTurnDetection1, RealtimeTurnDetection2]]]
):
    root: Optional[Union[RealtimeTurnDetection1, RealtimeTurnDetection2]]


class ReasoningEffort(
    RootModel[Optional[Literal['none', 'minimal', 'low', 'medium', 'high']]]
):
    root: Optional[Literal['none', 'minimal', 'low', 'medium', 'high']]
...
class ResponseModalities(RootModel[Optional[List[Literal['text', 'audio']]]]):
    root: Optional[List[Literal['text', 'audio']]]
...
class ResponseStreamOptions(RootModel[Optional[ResponseStreamOptions1]]):
    root: Optional[ResponseStreamOptions1]
...
class RunCompletionUsage(RootModel[Optional[RunCompletionUsage1]]):
    root: Optional[RunCompletionUsage1]
...
class Errors1(BaseModel):
    ...
    model_grader_server_error_details: Optional[str] = None
...
class RunStepCompletionUsage(RootModel[Optional[RunStepCompletionUsage1]]):
    root: Optional[RunStepCompletionUsage1]
...
class ServiceTier(
    RootModel[Optional[Literal['auto', 'default', 'flex', 'scale', 'priority']]]
):
    root: Optional[Literal['auto', 'default', 'flex', 'scale', 'priority']]
...
class StopConfiguration1(RootModel[Optional[List[str]]]):
    root: Annotated[
        Optional[List[str]],
        Field(
...
class StopConfiguration(RootModel[Optional[Union[Optional[str], StopConfiguration1]]]):
    root: Annotated[
...
class ThreadStreamEvent(RootModel[ThreadStreamEvent1]):
    root: Annotated[ThreadStreamEvent1, Field(discriminator='event')]
...
class LastMessages(RootModel[int]):
    root: Annotated[
        int,
        Field(
...
class VectorStoreFileAttributes(
    RootModel[Optional[Dict[str, Union[VectorStoreFileAttributes1, float, bool]]]]
):
    root: Optional[Dict[str, Union[VectorStoreFileAttributes1, float, bool]]]
...
class Verbosity(RootModel[Optional[Literal['low', 'medium', 'high']]]):
    root: Optional[Literal['low', 'medium', 'high']]
...
class WebSearchApproximateLocation(RootModel[Optional[WebSearchApproximateLocation1]]):
    root: Optional[WebSearchApproximateLocation1]
...
class ConversationParam2(BaseModel):
    id: Annotated[
        str,
        Field(description='The unique ID of the conversation.', examples=['conv_123']),
    ]
...
class ChatkitWorkflow(BaseModel):
    ...
    state_variables: Optional[Dict[str, Union[str, int, bool, float]]] = None
    tracing: Annotated[
...
class StateVariables(RootModel[str]):
...
class Content11(RootModel[Union[UserMessageInputText, UserMessageQuotedText]]):
    root: Annotated[
...
class Annotations(RootModel[Union[FileAnnotation, UrlAnnotation]]):
    root: Annotated[
...
class AssistantsApiToolChoiceOption(
    RootModel[Union[Literal['none', 'auto', 'required'], AssistantsNamedToolChoice]]
):
    root: Annotated[
...
class ConversationParam(RootModel[Union[str, ConversationParam2]]):
    root: Annotated[
...
class Input3(RootModel[Union[ModerationImageURLInput, ModerationTextInput]]):
    root: Annotated[
...
class CreateSpeechResponseStreamEvent(
    RootModel[Union[SpeechAudioDeltaEvent, SpeechAudioDoneEvent]]
):
    root: Annotated[
...
class ImageEditStreamEvent(
    RootModel[Union[ImageEditPartialImageEvent, ImageEditCompletedEvent]]
):
    root: Annotated[
...
class ImageGenStreamEvent(
    RootModel[Union[ImageGenPartialImageEvent, ImageGenCompletedEvent]]
):
    root: Annotated[
...
class ListBatchesResponse(BaseModel):
    data: List[Batch]
    first_id: Annotated[Optional[str], Field(examples=['batch_abc123'])] = None
    last_id: Annotated[Optional[str], Field(examples=['batch_abc456'])] = None
    has_more: bool
    object: Literal['list']
...
class ModelIdsShared(RootModel[Union[str, ChatModel]]):
    root: Annotated[Union[str, ChatModel], Field(examples=['gpt-4o'])]
...
class RealtimeBetaServerEventTranscriptionSessionCreated(BaseModel):
    event_id: Annotated[str, Field(description='The unique ID of the server event.')]
    type: Annotated[
        Literal['transcription_session.created'],
        Field(description='The event type, must be `transcription_session.created`.'),
    ]
...
class Tools2(RootModel[Union[RealtimeFunctionTool, MCPTool]]):
    root: Annotated[Union[RealtimeFunctionTool, MCPTool], Field(discriminator='type')]
...
class TranscriptionChunkingStrategy(
    RootModel[Optional[Union[Literal['auto'], VadConfig]]]
):
    root: Optional[Union[Literal['auto'], VadConfig]]
...
class Content5(RootModel[Union[InputContent, OutputContent]]):
    root: Annotated[
...
class Tools(RootModel[Union[ChatCompletionTool, CustomToolChatCompletions]]):
    root: Annotated[
...
class Prompt2(RootModel[Optional[Prompt3]]):
    root: Optional[Prompt3]
...
class InputItem1(RootModel[Union[EasyInputMessage, Item, ItemReferenceParam]]):
    root: Annotated[
        Union[EasyInputMessage, Item, ItemReferenceParam], Field(discriminator='type')
    ]


class InputParam(RootModel[Union[str, List[InputItem1]]]):
    root: Annotated[
...
class Response1(ModelResponseProperties, ResponseProperties):
    ...
    instructions: Optional[Union[str, List[InputItem1]]] = None
...
class Items(RootModel[List[InputItem1]]):
    root: Annotated[
        List[InputItem1],
        Field(
