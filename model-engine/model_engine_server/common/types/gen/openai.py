...
#   timestamp: 2024-09-10T16:20:49+00:00
...
class JsonSchema(BaseModel):
    ...
    schema_: Annotated[Optional[ResponseFormatJsonSchemaSchema], Field(None, alias="schema")]
    strict: Annotated[
        Optional[bool],
        Field(
            False,
...
class ChatCompletionStreamResponseDelta(BaseModel):
    ...
    refusal: Annotated[
        Optional[str],
        Field(None, description="The refusal message generated by the model."),
    ]
...
class AuditLogActorServiceAccount(BaseModel):
    id: Annotated[Optional[str], Field(None, description="The service account id.")]


class AuditLogActorUser(BaseModel):
    id: Annotated[Optional[str], Field(None, description="The user id.")]
    email: Annotated[Optional[str], Field(None, description="The user email.")]


class AuditLogActorApiKey(BaseModel):
    id: Annotated[Optional[str], Field(None, description="The tracking id of the API key.")]
    type: Annotated[
...
class AuditLogActorSession(BaseModel):
    ...
    ip_address: Annotated[
        Optional[str],
        Field(None, description="The IP address from which the action was performed."),
    ]
...
class AuditLogActor(BaseModel):
    type: Annotated[
        ...
        Field(None, description="The type of actor. Is either `session` or `api_key`."),
    ]
...
class Project(BaseModel):
    id: Annotated[Optional[str], Field(None, description="The project ID.")]
    name: Annotated[Optional[str], Field(None, description="The project title.")]
...
class ApiKeyCreated(BaseModel):
    ...
    data: Annotated[
        Optional[Data],
        Field(None, description="The payload used to create the API key."),
    ]
...
class ApiKeyUpdated(BaseModel):
    ...
    changes_requested: Annotated[
        ...
        Field(None, description="The payload used to update the API key."),
    ]
...
class Data1(BaseModel):
    email: Annotated[
        Optional[str], Field(None, description="The email invited to the organization.")
    ]
    role: Annotated[
        Optional[str],
        Field(
...
class InviteSent(BaseModel):
    id: Annotated[Optional[str], Field(None, description="The ID of the invite.")]
    data: Annotated[
        Optional[Data1],
        Field(None, description="The payload used to create the invite."),
    ]
...
class LoginFailed(BaseModel):
    error_code: Annotated[Optional[str], Field(None, description="The error code of the failure.")]
    error_message: Annotated[
        Optional[str], Field(None, description="The error message of the failure.")
    ]
...
class ChangesRequested1(BaseModel):
    title: Annotated[Optional[str], Field(None, description="The organization title.")]
    description: Annotated[Optional[str], Field(None, description="The organization description.")]
    name: Annotated[Optional[str], Field(None, description="The organization name.")]
    settings: Optional[Settings] = None


class OrganizationUpdated(BaseModel):
    id: Annotated[Optional[str], Field(None, description="The organization ID.")]
    changes_requested: Annotated[
        Optional[ChangesRequested1],
        Field(None, description="The payload used to update the organization settings."),
    ]


class Data2(BaseModel):
    name: Annotated[Optional[str], Field(None, description="The project name.")]
    title: Annotated[
        Optional[str],
        Field(None, description="The title of the project as seen on the dashboard."),
    ]
...
class ProjectCreated(BaseModel):
    ...
    data: Annotated[
        Optional[Data2],
        Field(None, description="The payload used to create the project."),
    ]
...
class ProjectUpdated(BaseModel):
    ...
    changes_requested: Annotated[
        ...
        Field(None, description="The payload used to update the project."),
    ]
...
class ServiceAccountCreated(BaseModel):
    ...
    data: Annotated[
        Optional[Data3],
        Field(None, description="The payload used to create the service account."),
    ]
...
class Data4(BaseModel):
    role: Annotated[
        Optional[str],
        Field(None, description="The role of the user. Is either `owner` or `member`."),
    ]
...
class UserAdded(BaseModel):
    ...
    data: Annotated[
        Optional[Data4],
        Field(None, description="The payload used to add the user to the project."),
    ]
...
class UserUpdated(BaseModel):
    ...
    changes_requested: Annotated[
        ...
        Field(None, description="The payload used to update the user."),
    ]
...
class InviteListResponse(BaseModel):
    ...
    first_id: Annotated[
        Optional[str],
        Field(None, description="The first `invite_id` in the retrieved `list`"),
    ]
    last_id: Annotated[
        Optional[str],
        Field(None, description="The last `invite_id` in the retrieved `list`"),
    ]
    has_more: Annotated[
        Optional[bool],
        Field(
...
class Owner(BaseModel):
    type: Annotated[
        Optional[Literal["user", "service_account"]],
        Field(None, description="`user` or `service_account`"),
    ]
...
class ChatCompletionRequestAssistantMessage(BaseModel):
    ...
    refusal: Annotated[
        Optional[str], Field(None, description="The refusal message by the assistant.")
    ]
    role: Annotated[
        Literal["assistant"],
