...
#   timestamp: 2024-09-30T08:39:28+00:00
...
class Choice(BaseModel):
    ...
    index: int
    logprobs: Annotated[Optional[Logprobs], Field(...)]
    text: str
...
class Content(RootModel[List[ChatCompletionRequestSystemMessageContentPart]]):
    root: Annotated[
...
class Content1(RootModel[List[ChatCompletionRequestUserMessageContentPart]]):
    root: Annotated[
...
class Content2(RootModel[Optional[List[ChatCompletionRequestAssistantMessageContentPart]]]):
    root: Annotated[
...
class ChatCompletionRole(RootModel[Literal["system", "user", "assistant", "tool", "function"]]):
    root: Annotated[
...
class CreateImageRequest(BaseModel):
    ...
    model: Annotated[
        Optional[Union[Optional[str], Literal["dall-e-2", "dall-e-3"]]],
        Field(description="The model to use for image generation.", examples=["dall-e-3"]),
    ] = "dall-e-2"
    n: Annotated[
        Optional[int],
        Field(
...
class CreateCompletionRequest(BaseModel):
    ...
    stop: Annotated[
        Optional[Union[Optional[str], Stop]],
        Field(
            description="Up to 4 sequences where the API will stop generating further tokens. The returned text will not contain the stop sequence.\n"
        ),
    ] = None
...
class RunObject(BaseModel):
    ...
    truncation_strategy: Annotated[Optional[TruncationObject], Field(...)]
    tool_choice: Annotated[Optional[AssistantsApiToolChoiceOption], Field(...)]
...
class ChatCompletionRequestAssistantMessage(BaseModel):
    content: Annotated[
        Optional[Union[Optional[str], Content2]],
        Field(
