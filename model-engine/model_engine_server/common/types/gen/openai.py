...
#   timestamp: 2026-01-09T22:40:33+00:00
...
class Owner(BaseModel):
    type: Annotated[str | None, Field(description="Always `user`", examples=["user"])] = None
    object: Annotated[
        str | None,
        Field(
    ...
    role: Annotated[str | None, Field(description="Always `owner`", examples=["owner"])] = None
...
class ApiKeyCreated(BaseModel):
    id: Annotated[str | None, Field(description="The tracking ID of the API key.")] = None
    data: Annotated[Data | None, Field(description="The payload used to create the API key.")] = (
        None
    )
...
class CheckpointPermissionCreated(BaseModel):
    id: Annotated[str | None, Field(description="The ID of the checkpoint permission.")] = None
    data: Annotated[
        Data1 | None,
...
class Data2(BaseModel):
    email: Annotated[str | None, Field(description="The email invited to the organization.")] = None
    role: Annotated[
        str | None,
...
class InviteSent(BaseModel):
    ...
    data: Annotated[Data2 | None, Field(description="The payload used to create the invite.")] = (
        None
    )
...
class LoginFailed(BaseModel):
    error_code: Annotated[str | None, Field(description="The error code of the failure.")] = None
    error_message: Annotated[str | None, Field(description="The error message of the failure.")] = (
        None
    )
...
class ChangesRequested1(BaseModel):
    ...
    description: Annotated[str | None, Field(description="The organization description.")] = None
...
class ProjectCreated(BaseModel):
    id: Annotated[str | None, Field(description="The project ID.")] = None
    data: Annotated[Data3 | None, Field(description="The payload used to create the project.")] = (
        None
    )
...
class CertificateCreated(BaseModel):
    ...
    name: Annotated[str | None, Field(description="The name of the certificate.")] = None
...
class Datum(BaseModel):
    code: Annotated[str | None, Field(description="An error code identifying the error type.")] = (
        None
    )
    message: Annotated[
        str | None,
...
class Errors(BaseModel):
    object: Annotated[str | None, Field(description="The object type, which is always `list`.")] = (
        None
    )
...
class Response(BaseModel):
    ...
    body: Annotated[dict[str, Any] | None, Field(description="The JSON body of the response")] = (
        None
    )


class Error(BaseModel):
    code: Annotated[str | None, Field(description="A machine-readable error code.")] = None
...
class Function2(BaseModel):
    name: Annotated[str | None, Field(description="The name of the function to call.")] = None
    arguments: Annotated[
        str | None,
        Field(
            description="The arguments to call the function with, as generated by the model in JSON format. Note that the model does not always generate valid JSON, and may hallucinate parameters not defined by your function schema. Validate the arguments in your code before calling your function."
...
class ChatCompletionRequestFunctionMessage(BaseModel):
    ...
    content: Annotated[str | None, Field(description="The contents of the function message.")]
    name: Annotated[str, Field(description="The name of the function to call.")]
...
class ChatCompletionResponseMessage(BaseModel):
    content: Annotated[str | None, Field(description="The contents of the message.")]
    refusal: Annotated[str | None, Field(description="The refusal message generated by the model.")]
...
class ChatCompletionStreamResponseDelta(BaseModel):
    content: Annotated[str | None, Field(description="The contents of the chunk message.")] = None
    function_call: Annotated[
        FunctionCall2 | None,
        Field(
            deprecated=True,
...
class CodeInterpreterToolOutput(RootModel[CodeInterpreterTextOutput | CodeInterpreterFileOutput]):
...
class ComputerScreenshotImage(BaseModel):
    ...
    image_url: Annotated[str | None, Field(description="The URL of the screenshot image.")] = None
    file_id: Annotated[
        str | None,
...
class Amount(BaseModel):
    value: Annotated[float | None, Field(description="The numeric value of the cost.")] = None
    currency: Annotated[str | None, Field(description='Lowercase ISO-4217 currency e.g. "usd"')] = (
        None
    )
...
class CreateEmbeddingRequest(BaseModel):
    ...
    model: Annotated[
        str | Literal["text-embedding-ada-002", "text-embedding-3-small", "text-embedding-3-large"],
        Field(
...
class CreateImageEditRequest(BaseModel):
    ...
    size: Annotated[
        Literal["256x256", "512x512", "1024x1024", "1536x1024", "1024x1536", "auto"] | None,
        Field(
...
class Logprob(BaseModel):
    token: Annotated[str | None, Field(description="The token in the transcription.")] = None
    logprob: Annotated[float | None, Field(description="The log probability of the token.")] = None
    bytes: Annotated[list[float] | None, Field(description="The bytes of the token.")] = None
...
class EvalPythonGrader(BaseModel):
    ...
    pass_threshold: Annotated[float | None, Field(description="The threshold for the score.")] = (
        None
    )
    image_tag: Annotated[
...
class OutputItem(BaseModel):
    ...
    content: Annotated[str | None, Field(description="The content of the message.")] = None
...
class FunctionToolCall(BaseModel):
    id: Annotated[str | None, Field(description="The unique ID of the function tool call.\n")] = (
        None
    )
    type: Annotated[
...
class ImagesResponse(BaseModel):
    ...
    data: Annotated[list[Image1] | None, Field(description="The list of generated images.")] = None
    usage: Annotated[
        Usage2 | None,
        Field(
...
class FileCitation1(BaseModel):
    ...
    quote: Annotated[str | None, Field(description="The specific quote in the file.")] = None
...
class FilePath2(BaseModel):
    file_id: Annotated[str | None, Field(description="The ID of the file that was generated.")] = (
        None
    )
...
class Text1(BaseModel):
    value: Annotated[str | None, Field(description="The data that makes up the text.")] = None
    annotations: (
        list[
...
class StatusDetails(BaseModel):
    ...
    reason: Annotated[
        Literal["turn_detected", "client_cancelled", "max_output_tokens", "content_filter"] | None,
        Field(
...
class Error4(BaseModel):
    ...
    code: Annotated[str | None, Field(description="Error code, if any.")] = None
    message: Annotated[str | None, Field(description="A human-readable error message.")] = None
    param: Annotated[str | None, Field(description="Parameter related to the error, if any.")] = (
        None
    )
...
class RunStepDeltaStepDetailsToolCallsFileSearchObject(BaseModel):
    ...
    id: Annotated[str | None, Field(description="The ID of the tool call object.")] = None
    type: Annotated[
        Literal["file_search"],
        Field(
...
class Function4(BaseModel):
    name: Annotated[str | None, Field(description="The name of the function.")] = None
    arguments: Annotated[str | None, Field(description="The arguments passed to the function.")] = (
        None
    )
    output: Annotated[
        str | None,
...
class ContentItem3(BaseModel):
    type: Annotated[Literal["text"] | None, Field(description="The type of the content.")] = None
    text: Annotated[str | None, Field(description="The text content of the file.")] = None
...
class Logprob1(BaseModel):
    ...
    logprob: Annotated[float | None, Field(description="The log probability of the token.\n")] = (
        None
    )
    bytes: Annotated[
        list[Any] | None,
...
class UploadCertificateRequest(BaseModel):
    name: Annotated[str | None, Field(description="An optional name for the certificate")] = None
...
class VectorStoreFileAttributes(
    RootModel[dict[constr(max_length=64), VectorStoreFileAttributes1 | float | bool] | None]
):
    root: Annotated[
...
class Datum2(BaseModel):
    type: Annotated[str | None, Field(description='The content type (currently only `"text"`)')] = (
        None
    )
...
class VectorStoreFileContentResponse(BaseModel):
    ...
    next_page: Annotated[str | None, Field(description="The token for the next page, if any.")]
...
class VectorStoreSearchRequest(BaseModel):
    ...
    query: Annotated[str | list[QueryItem], Field(description="A query string for a search")]
...
class ToolModel(
    RootModel[FileSearchTool | FunctionTool | WebSearchPreviewTool | ComputerUsePreviewTool]
):
    root: Annotated[
...
class AnnotationModel(RootModel[FileCitationBody | UrlCitationBody | FilePath]):
    root: Annotated[FileCitationBody | UrlCitationBody | FilePath, Field(discriminator="type")]
...
class ChatCompletionRequestDeveloperMessage(BaseModel):
    content: Annotated[str | Content1, Field(description="The contents of the developer message.")]
    role: Annotated[
        Literal["developer"],
...
class ChatCompletionRequestSystemMessage(BaseModel):
    content: Annotated[str | Content2, Field(description="The contents of the system message.")]
    role: Annotated[
        Literal["system"],
...
class ChatCompletionRequestToolMessage(BaseModel):
    ...
    content: Annotated[str | Content3, Field(description="The contents of the tool message.")]
...
class ChatCompletionRequestUserMessage(BaseModel):
    content: Annotated[str | Content4, Field(description="The contents of the user message.\n")]
    role: Annotated[
        Literal["user"],
...
class ComputerAction(
    RootModel[Click | DoubleClick | Drag | KeyPress | Move | Screenshot | Scroll | Type | Wait]
):
...
class ComputerToolCallOutput(BaseModel):
    ...
    id: Annotated[str | None, Field(description="The ID of the computer tool call output.\n")] = (
        None
    )
    call_id: Annotated[
        str,
...
class CreateTranscriptionResponseStreamEvent(
    ...
    root: Annotated[TranscriptTextDeltaEvent | TranscriptTextDoneEvent, Field(discriminator="type")]
...
class CreateVectorStoreRequest(BaseModel):
    ...
    name: Annotated[str | None, Field(description="The name of the vector store.")] = None
    expires_after: VectorStoreExpirationAfter | None = None
    chunking_strategy: Annotated[
...
class Result1(BaseModel):
    file_id: Annotated[str | None, Field(description="The unique ID of the file.\n")] = None
    text: Annotated[
...
class RealtimeResponse(BaseModel):
    id: Annotated[str | None, Field(description="The unique ID of the response.")] = None
    object: Annotated[
...
class TextResponseFormatConfiguration(
    RootModel[ResponseFormatText | TextResponseFormatJsonSchema | ResponseFormatJsonObject]
):
    root: Annotated[
...
class ChatCompletionRequestAssistantMessage(BaseModel):
    ...
    refusal: Annotated[str | None, Field(description="The refusal message by the assistant.")] = (
        None
    )
    role: Annotated[
        Literal["assistant"],
...
class CreateRunRequest(BaseModel):
    ...
    tools: Annotated[
        list[AssistantToolsCode | AssistantToolsFileSearch | AssistantToolsFunction] | None,
        Field(
