  ...
  "Statement": [
    {
      ...
      "Action": "sqs:*",
      "Resource": "arn:aws:sqs:us-west-2:000000000000:launch-endpoint-id-test_model_endpoint_id_3"
    },
    {
      "Effect": "Allow",
      "Principal": {
...
def mock_create_async_sqs_client_delete_queue():
    ...
    mock_sqs_client_session_val.get_queue_url.return_value = {
        "QueueUrl": "https://us-west-2.queue.amazonaws.com/000000000000/launch-endpoint-id-model_endpoint_id_1"
    }
